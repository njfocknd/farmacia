...
INSERT INTO `cliente` VALUES (1,1,NULL,NULL,'Nestor Fock',NULL,200.00,700.00,NULL,NULL,'Activo'),(2,2,NULL,'7808912-2','Silvia Gómez','Ciudad',0.00,0.00,NULL,'njfock@gmail.com','Activo');
...
INSERT INTO `cuenta` VALUES (1,1,1,1,'898','CHN CUENTA',0.00,0.00,0.00,'Activo',NULL);
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_ingreso_BEFORE_INSERT` BEFORE INSERT ON `detalle_documento_ingreso` FOR EACH ROW
BEGIN
	set new.fecha_insercion = now();
    set new.monto = new.cantidad*new.precio;
END */;;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_ingreso_AFTER_INSERT` AFTER INSERT ON `detalle_documento_ingreso` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_ingreso_BEFORE_UPDATE` BEFORE UPDATE ON `detalle_documento_ingreso` FOR EACH ROW
BEGIN
	set new.monto = new.cantidad*new.precio;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_ingreso_AFTER_UPDATE` AFTER UPDATE ON `detalle_documento_ingreso` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_interno_BEFORE_INSERT` BEFORE INSERT ON `detalle_documento_interno` FOR EACH ROW
BEGIN
	set new.fecha_insercion = now();
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_interno_AFTER_INSERT` AFTER INSERT ON `detalle_documento_interno` FOR EACH ROW
BEGIN
	INSERT INTO producto_historial (idproducto, idbodega, fecha, unidades_salida, idrelacion, tabla_relacion) 
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_interno_BEFORE_UPDATE` BEFORE UPDATE ON `detalle_documento_interno` FOR EACH ROW
BEGIN
	set new.monto = new.cantidad*new.precio;
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`detalle_documento_interno_AFTER_UPDATE` AFTER UPDATE ON `detalle_documento_interno` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_AFTER_INSERT` AFTER INSERT ON `documento` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_BEFORE_UPDATE` BEFORE UPDATE ON `documento` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_AFTER_UPDATE` AFTER UPDATE ON `documento` FOR EACH ROW
BEGIN
    if new.monto != old.monto then
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_ingreso_BEFORE_INSERT` BEFORE INSERT ON `documento_ingreso` FOR EACH ROW
BEGIN
	set new.fecha_insercion = now();
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_ingreso_AFTER_INSERT` AFTER INSERT ON `documento_ingreso` FOR EACH ROW
BEGIN
	insert into movimiento (credito, idrelacion, tabla_relacion, idrelacion_persona, tabla_relacion_persona, idsucursal)
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_ingreso_BEFORE_UPDATE` BEFORE UPDATE ON `documento_ingreso` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_ingreso_AFTER_UPDATE` AFTER UPDATE ON `documento_ingreso` FOR EACH ROW
BEGIN
	if new.monto != old.monto then
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_interno_BEFORE_INSERT` BEFORE INSERT ON `documento_interno` FOR EACH ROW
BEGIN
	declare var_serie VARCHAR(45);
	declare var_correlativo int;
	declare var_fecha date;
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_interno_AFTER_INSERT` AFTER INSERT ON `documento_interno` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_interno_BEFORE_UPDATE` BEFORE UPDATE ON `documento_interno` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `nexthor_empresa`.`documento_interno_AFTER_UPDATE` AFTER UPDATE ON `documento_interno` FOR EACH ROW
BEGIN
	if new.monto != old.monto then
...
INSERT INTO `pago_cliente` VALUES (1,1,200.00,NULL,'Inactivo','2015-11-06 02:44:40',1),(2,1,100.00,'2015-11-08','Activo','2015-11-08 23:09:05',1);
...
INSERT INTO `pago_proveedor` VALUES (2,1,100.00,'2015-11-08','Activo','2015-11-09 00:41:41',1);
...
INSERT INTO `proveedor` VALUES (1,1,NULL,'23','GFSD','EDRF',0.00,100.00,NULL,'32@KLD.COM','Activo'),(2,2,NULL,'23','GFSD','EDRF',0.00,0.00,NULL,'32@KLD.COM','Activo');
...
INSERT INTO `sucursal` VALUES (1,'Farmacia Petapa','Av. Petapa',1,1,'Activo',2300.00,1600.00),(2,'Farmacia Monte Maria',NULL,1,1,'Activo',1000.00,1000.00);
...
-- Dump completed on 2015-11-08 21:24:33
