...
function show_table()
	...
	strparams = { 'anio': anio, 'mes': mes,  'idsucursal': idsucursal,'nexthor_pie_cliente': 1 };
	$.post( "nexthor_pie_cliente_tabla.php", strparams, function(html){$(div).html(html);});
	}
</SCRIPT>
<?php
...
{?>
	<ul class="nav nav-pills">
	  ...
	  <li class="active"><a  href="nexthor_pie_cliente.php">Gráfica Clientes</a></li>
