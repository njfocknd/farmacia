...
$producto_sucursal_add = NULL; // Initialize page object first

class cproducto_sucursal_add extends cproducto_sucursal {
	...
	// Page object name
	var $PageObjName = 'producto_sucursal_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["idproducto_sucursal"] != "") {
				...
				$this->setKey("idproducto_sucursal", $this->idproducto_sucursal->CurrentValue); // Set up key
			} else {
				$this->setKey("idproducto_sucursal", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "producto_sucursalview.php")
...
// Create page object
if (!isset($producto_sucursal_add)) $producto_sucursal_add = new cproducto_sucursal_add();

// Page init
$producto_sucursal_add->Page_Init();

// Page main
$producto_sucursal_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$producto_sucursal_add->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var producto_sucursal_add = new ew_Page("producto_sucursal_add");
producto_sucursal_add.PageID = "add"; // Page ID
var EW_PAGE_ID = producto_sucursal_add.PageID; // For backward compatibility

// Form object
var fproducto_sucursaladd = new ew_Form("fproducto_sucursaladd");

// Validate form
fproducto_sucursaladd.Validate = function() {
...
fproducto_sucursaladd.Form_CustomValidate = 
...
fproducto_sucursaladd.ValidateRequired = true;
<?php } else { ?>
fproducto_sucursaladd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fproducto_sucursaladd.Lists["x_idproducto"] = {"LinkField":"x_idproducto","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fproducto_sucursaladd.Lists["x_idsucursal"] = {"LinkField":"x_idsucursal","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $producto_sucursal_add->ShowPageHeader(); ?>
<?php
$producto_sucursal_add->ShowMessage();
?>
<form name="fproducto_sucursaladd" id="fproducto_sucursaladd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($producto_sucursal_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $producto_sucursal_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fproducto_sucursaladd.Init();
</script>
<?php
$producto_sucursal_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$producto_sucursal_add->Page_Terminate();
?>
