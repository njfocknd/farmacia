...
$fabricante_edit = NULL; // Initialize page object first

class cfabricante_edit extends cfabricante {
	...
	// Page object name
	var $PageObjName = 'fabricante_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->idfabricante->CurrentValue == "")
			$this->Page_Terminate("fabricantelist.php"); // Invalid key, return to list
...
// Create page object
if (!isset($fabricante_edit)) $fabricante_edit = new cfabricante_edit();

// Page init
$fabricante_edit->Page_Init();

// Page main
$fabricante_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fabricante_edit->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var fabricante_edit = new ew_Page("fabricante_edit");
fabricante_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = fabricante_edit.PageID; // For backward compatibility

// Form object
var ffabricanteedit = new ew_Form("ffabricanteedit");

// Validate form
ffabricanteedit.Validate = function() {
...
ffabricanteedit.Form_CustomValidate = 
...
ffabricanteedit.ValidateRequired = true;
<?php } else { ?>
ffabricanteedit.ValidateRequired = false; 
<?php } ?>
...
<?php $fabricante_edit->ShowPageHeader(); ?>
<?php
$fabricante_edit->ShowMessage();
?>
<form name="ffabricanteedit" id="ffabricanteedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($fabricante_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $fabricante_edit->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ffabricanteedit.Init();
</script>
<?php
$fabricante_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$fabricante_edit->Page_Terminate();
?>
