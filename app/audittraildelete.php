...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_id" class="form-group audittrail_id">
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_datetime" class="form-group audittrail_datetime">
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_script" class="form-group audittrail_script">
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_user" class="form-group audittrail_user">
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail_action" class="form-group audittrail_action">
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail__table" class="form-group audittrail__table">
...
<span id="el<?php echo $audittrail_delete->RowCnt ?>_audittrail__field" class="form-group audittrail__field">
