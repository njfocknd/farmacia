...
fregistro_sanitariogrid.EmptyRow = function(infix) {
	var fobj = this.Form;
	if (ew_ValueChanged(fobj, infix, "idmedicamento", false)) return false;
...
fregistro_sanitariogrid.Lists["x_idmedicamento"] = {"LinkField":"x_idmedicamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php if ($registro_sanitario->idmedicamento->Visible) { // idmedicamento ?>
	...
	<?php } else { ?>
		<th data-name="idmedicamento"><div><div id="elh_registro_sanitario_idmedicamento" class="registro_sanitario_idmedicamento">
...
<?php if ($registro_sanitario->estado->Visible) { // estado ?>
	...
	<?php } else { ?>
		<th data-name="estado"><div><div id="elh_registro_sanitario_estado" class="registro_sanitario_estado">
...
<span id="el<?php echo $registro_sanitario_grid->RowCnt ?>_registro_sanitario_idmedicamento" class="form-group registro_sanitario_idmedicamento">
...
<input type="hidden" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" value="<?php echo ew_HtmlEncode($registro_sanitario->idmedicamento->CurrentValue) ?>">
<?php } else { ?>
<span id="el<?php echo $registro_sanitario_grid->RowCnt ?>_registro_sanitario_idmedicamento" class="form-group registro_sanitario_idmedicamento">
<select data-field="x_idmedicamento" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento"<?php echo $registro_sanitario->idmedicamento->EditAttributes() ?>>
<?php
...
if (@$emptywrk) $registro_sanitario->idmedicamento->OldValue = "";
?>
</select>
<?php
...
?>
<input type="hidden" name="s_x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" id="s_x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" value="s=<?php echo ew_Encrypt($sSqlWrk) ?>&amp;f0=<?php echo ew_Encrypt("`idmedicamento` = {filter_value}"); ?>&amp;t0=3">
</span>
<?php } ?>
<input type="hidden" data-field="x_idmedicamento" name="o<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" id="o<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" value="<?php echo ew_HtmlEncode($registro_sanitario->idmedicamento->OldValue) ?>">
<?php } ?>
...
<input type="hidden" data-field="x_idmedicamento" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" value="<?php echo ew_HtmlEncode($registro_sanitario->idmedicamento->FormValue) ?>">
<input type="hidden" data-field="x_idmedicamento" name="o<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" id="o<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" value="<?php echo ew_HtmlEncode($registro_sanitario->idmedicamento->OldValue) ?>">
<?php } ?>
...
<input type="hidden" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_idpais" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_idpais" value="<?php echo ew_HtmlEncode($registro_sanitario->idpais->CurrentValue) ?>">
<?php } else { ?>
<span id="el<?php echo $registro_sanitario_grid->RowCnt ?>_registro_sanitario_idpais" class="form-group registro_sanitario_idpais">
...
<?php if ($registro_sanitario->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $registro_sanitario_grid->RowCnt ?>_registro_sanitario_estado" class="form-group registro_sanitario_estado">
<select data-field="x_estado" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado"<?php echo $registro_sanitario->estado->EditAttributes() ?>>
<?php
if (is_array($registro_sanitario->estado->EditValue)) {
	$arwrk = $registro_sanitario->estado->EditValue;
	$rowswrk = count($arwrk);
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($registro_sanitario->estado->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
		if ($selwrk <> "") $emptywrk = FALSE;
?>
<option value="<?php echo ew_HtmlEncode($arwrk[$rowcntwrk][0]) ?>"<?php echo $selwrk ?>>
<?php echo $arwrk[$rowcntwrk][1] ?>
...
if (@$emptywrk) $registro_sanitario->estado->OldValue = "";
?>
</select>
</span>
<input type="hidden" data-field="x_estado" name="o<?php echo $registro_sanitario_grid->RowIndex ?>_estado" id="o<?php echo $registro_sanitario_grid->RowIndex ?>_estado" value="<?php echo ew_HtmlEncode($registro_sanitario->estado->OldValue) ?>">
<?php } ?>
<?php if ($registro_sanitario->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $registro_sanitario_grid->RowCnt ?>_registro_sanitario_estado" class="form-group registro_sanitario_estado">
<select data-field="x_estado" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado"<?php echo $registro_sanitario->estado->EditAttributes() ?>>
...
<input type="hidden" data-field="x_estado" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado" value="<?php echo ew_HtmlEncode($registro_sanitario->estado->FormValue) ?>">
<input type="hidden" data-field="x_estado" name="o<?php echo $registro_sanitario_grid->RowIndex ?>_estado" id="o<?php echo $registro_sanitario_grid->RowIndex ?>_estado" value="<?php echo ew_HtmlEncode($registro_sanitario->estado->OldValue) ?>">
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($registro_sanitario->idmedicamento->getSessionValue() <> "") { ?>
<span id="el$rowindex$_registro_sanitario_idmedicamento" class="form-group registro_sanitario_idmedicamento">
<span<?php echo $registro_sanitario->idmedicamento->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $registro_sanitario->idmedicamento->ViewValue ?></p></span>
</span>
<input type="hidden" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_idmedicamento" value="<?php echo ew_HtmlEncode($registro_sanitario->idmedicamento->CurrentValue) ?>">
...
<input type="hidden" data-field="x_idpais" name="o<?php echo $registro_sanitario_grid->RowIndex ?>_idpais" id="o<?php echo $registro_sanitario_grid->RowIndex ?>_idpais" value="<?php echo ew_HtmlEncode($registro_sanitario->idpais->OldValue) ?>">
	...
	<?php if ($registro_sanitario->estado->Visible) { // estado ?>
		<td>
<?php if ($registro_sanitario->CurrentAction <> "F") { ?>
<span id="el$rowindex$_registro_sanitario_estado" class="form-group registro_sanitario_estado">
<select data-field="x_estado" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado"<?php echo $registro_sanitario->estado->EditAttributes() ?>>
<?php
if (is_array($registro_sanitario->estado->EditValue)) {
	$arwrk = $registro_sanitario->estado->EditValue;
...
<span id="el$rowindex$_registro_sanitario_estado" class="form-group registro_sanitario_estado">
<span<?php echo $registro_sanitario->estado->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $registro_sanitario->estado->ViewValue ?></p></span>
</span>
<input type="hidden" data-field="x_estado" name="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado" id="x<?php echo $registro_sanitario_grid->RowIndex ?>_estado" value="<?php echo ew_HtmlEncode($registro_sanitario->estado->FormValue) ?>">
<?php } ?>
<input type="hidden" data-field="x_estado" name="o<?php echo $registro_sanitario_grid->RowIndex ?>_estado" id="o<?php echo $registro_sanitario_grid->RowIndex ?>_estado" value="<?php echo ew_HtmlEncode($registro_sanitario->estado->OldValue) ?>">
