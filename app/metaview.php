...
$meta_view = NULL; // Initialize page object first

class cmeta_view extends cmeta {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["idmeta"] <> "") {
			$this->RecKey["idmeta"] = $_GET["idmeta"];
			$KeyUrl .= "&amp;idmeta=" . urlencode($this->RecKey["idmeta"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idmeta"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idmeta"]);
		}
		...
		$this->idmeta->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idmeta"] <> "") {
				...
				$this->RecKey["idmeta"] = $this->idmeta->QueryStringValue;
			} else {
				$sReturnUrl = "metalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "metalist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "metalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			// idmeta
			$this->idmeta->LinkCustomAttributes = "";
			$this->idmeta->HrefValue = "";
			$this->idmeta->TooltipValue = "";
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_meta\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_meta',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fmetaview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($meta_view)) $meta_view = new cmeta_view();
...
// Page object
var meta_view = new ew_Page("meta_view");
meta_view.PageID = "view"; // Page ID
var EW_PAGE_ID = meta_view.PageID; // For backward compatibility

// Form object
var fmetaview = new ew_Form("fmetaview");

// Form_CustomValidate event
fmetaview.Form_CustomValidate = 
...
fmetaview.ValidateRequired = true;
<?php } else { ?>
fmetaview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmetaview.Lists["x_idsucursal"] = {"LinkField":"x_idsucursal","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fmetaview.Lists["x_idperiodo_contable"] = {"LinkField":"x_idperiodo_contable","Ajax":true,"AutoFill":false,"DisplayFields":["x_mes","x_anio","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } ?>
<?php $meta_view->ExportOptions->Render("body") ?>
<?php
	foreach ($meta_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($meta->Export == "") { ?>
...
<?php } ?>
<?php $meta_view->ShowPageHeader(); ?>
<?php
$meta_view->ShowMessage();
?>
<form name="fmetaview" id="fmetaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($meta_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $meta_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="meta">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($meta->idmeta->Visible) { // idmeta ?>
	<tr id="r_idmeta">
		<td><span id="elh_meta_idmeta"><?php echo $meta->idmeta->FldCaption() ?></span></td>
		<td<?php echo $meta->idmeta->CellAttributes() ?>>
<span id="el_meta_idmeta" class="form-group">
<span<?php echo $meta->idmeta->ViewAttributes() ?>>
<?php echo $meta->idmeta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($meta->idsucursal->Visible) { // idsucursal ?>
	<tr id="r_idsucursal">
		<td><span id="elh_meta_idsucursal"><?php echo $meta->idsucursal->FldCaption() ?></span></td>
		<td<?php echo $meta->idsucursal->CellAttributes() ?>>
<span id="el_meta_idsucursal" class="form-group">
<span<?php echo $meta->idsucursal->ViewAttributes() ?>>
<?php echo $meta->idsucursal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($meta->idperiodo_contable->Visible) { // idperiodo_contable ?>
	<tr id="r_idperiodo_contable">
		<td><span id="elh_meta_idperiodo_contable"><?php echo $meta->idperiodo_contable->FldCaption() ?></span></td>
		<td<?php echo $meta->idperiodo_contable->CellAttributes() ?>>
<span id="el_meta_idperiodo_contable" class="form-group">
<span<?php echo $meta->idperiodo_contable->ViewAttributes() ?>>
<?php echo $meta->idperiodo_contable->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($meta->monto->Visible) { // monto ?>
	<tr id="r_monto">
		<td><span id="elh_meta_monto"><?php echo $meta->monto->FldCaption() ?></span></td>
		<td<?php echo $meta->monto->CellAttributes() ?>>
...
<?php if ($meta->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_meta_estado"><?php echo $meta->estado->FldCaption() ?></span></td>
		<td<?php echo $meta->estado->CellAttributes() ?>>
<span id="el_meta_estado" class="form-group">
<span<?php echo $meta->estado->ViewAttributes() ?>>
<?php echo $meta->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($meta->fecha_insercion->Visible) { // fecha_insercion ?>
	<tr id="r_fecha_insercion">
		<td><span id="elh_meta_fecha_insercion"><?php echo $meta->fecha_insercion->FldCaption() ?></span></td>
		<td<?php echo $meta->fecha_insercion->CellAttributes() ?>>
<span id="el_meta_fecha_insercion" class="form-group">
<span<?php echo $meta->fecha_insercion->ViewAttributes() ?>>
<?php echo $meta->fecha_insercion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
