...
$registro_sanitario_view = NULL; // Initialize page object first

class cregistro_sanitario_view extends cregistro_sanitario {
	...
	// Page object name
	var $PageObjName = 'registro_sanitario_view';
	...
	function __construct() {
		...
		if (@$_GET["idregistro_sanitario"] <> "") {
			$this->RecKey["idregistro_sanitario"] = $_GET["idregistro_sanitario"];
			$KeyUrl .= "&amp;idregistro_sanitario=" . urlencode($this->RecKey["idregistro_sanitario"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idregistro_sanitario"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idregistro_sanitario"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idregistro_sanitario"] <> "") {
				...
				$this->RecKey["idregistro_sanitario"] = $this->idregistro_sanitario->QueryStringValue;
			} else {
				$sReturnUrl = "registro_sanitariolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "registro_sanitariolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "registro_sanitariolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($registro_sanitario_view)) $registro_sanitario_view = new cregistro_sanitario_view();

// Page init
$registro_sanitario_view->Page_Init();

// Page main
$registro_sanitario_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$registro_sanitario_view->Page_Render();
?>
...
// Page object
var registro_sanitario_view = new ew_Page("registro_sanitario_view");
registro_sanitario_view.PageID = "view"; // Page ID
var EW_PAGE_ID = registro_sanitario_view.PageID; // For backward compatibility

// Form object
var fregistro_sanitarioview = new ew_Form("fregistro_sanitarioview");

// Form_CustomValidate event
fregistro_sanitarioview.Form_CustomValidate = 
...
fregistro_sanitarioview.ValidateRequired = true;
<?php } else { ?>
fregistro_sanitarioview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $registro_sanitario_view->ExportOptions->Render("body") ?>
<?php
	foreach ($registro_sanitario_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($registro_sanitario->Export == "") { ?>
...
<?php } ?>
<?php $registro_sanitario_view->ShowPageHeader(); ?>
<?php
$registro_sanitario_view->ShowMessage();
?>
<form name="fregistro_sanitarioview" id="fregistro_sanitarioview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($registro_sanitario_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $registro_sanitario_view->Token ?>">
<?php } ?>
...
<?php if ($registro_sanitario->idregistro_sanitario->Visible) { // idregistro_sanitario ?>
	<tr id="r_idregistro_sanitario">
		<td><span id="elh_registro_sanitario_idregistro_sanitario"><?php echo $registro_sanitario->idregistro_sanitario->FldCaption() ?></span></td>
		<td<?php echo $registro_sanitario->idregistro_sanitario->CellAttributes() ?>>
<span id="el_registro_sanitario_idregistro_sanitario" class="form-group">
<span<?php echo $registro_sanitario->idregistro_sanitario->ViewAttributes() ?>>
<?php echo $registro_sanitario->idregistro_sanitario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($registro_sanitario->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_registro_sanitario_descripcion"><?php echo $registro_sanitario->descripcion->FldCaption() ?></span></td>
		<td<?php echo $registro_sanitario->descripcion->CellAttributes() ?>>
<span id="el_registro_sanitario_descripcion" class="form-group">
<span<?php echo $registro_sanitario->descripcion->ViewAttributes() ?>>
<?php echo $registro_sanitario->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($registro_sanitario->idpais->Visible) { // idpais ?>
	<tr id="r_idpais">
		<td><span id="elh_registro_sanitario_idpais"><?php echo $registro_sanitario->idpais->FldCaption() ?></span></td>
		<td<?php echo $registro_sanitario->idpais->CellAttributes() ?>>
<span id="el_registro_sanitario_idpais" class="form-group">
<span<?php echo $registro_sanitario->idpais->ViewAttributes() ?>>
<?php echo $registro_sanitario->idpais->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fregistro_sanitarioview.Init();
</script>
<?php
$registro_sanitario_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($registro_sanitario->Export == "") { ?>
...
<?php
$registro_sanitario_view->Page_Terminate();
?>
