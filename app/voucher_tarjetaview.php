...
$voucher_tarjeta_view = NULL; // Initialize page object first

class cvoucher_tarjeta_view extends cvoucher_tarjeta {
	...
	// Page object name
	var $PageObjName = 'voucher_tarjeta_view';
	...
	function __construct() {
		...
		if (@$_GET["idvoucher_tarjeta"] <> "") {
			$this->RecKey["idvoucher_tarjeta"] = $_GET["idvoucher_tarjeta"];
			$KeyUrl .= "&amp;idvoucher_tarjeta=" . urlencode($this->RecKey["idvoucher_tarjeta"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idvoucher_tarjeta"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idvoucher_tarjeta"]);
		}
		...
		$this->idvoucher_tarjeta->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idvoucher_tarjeta"] <> "") {
				...
				$this->RecKey["idvoucher_tarjeta"] = $this->idvoucher_tarjeta->QueryStringValue;
			} else {
				$sReturnUrl = "voucher_tarjetalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "voucher_tarjetalist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "voucher_tarjetalist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($voucher_tarjeta_view)) $voucher_tarjeta_view = new cvoucher_tarjeta_view();

// Page init
$voucher_tarjeta_view->Page_Init();

// Page main
$voucher_tarjeta_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$voucher_tarjeta_view->Page_Render();
?>
...
// Page object
var voucher_tarjeta_view = new ew_Page("voucher_tarjeta_view");
voucher_tarjeta_view.PageID = "view"; // Page ID
var EW_PAGE_ID = voucher_tarjeta_view.PageID; // For backward compatibility

// Form object
var fvoucher_tarjetaview = new ew_Form("fvoucher_tarjetaview");

// Form_CustomValidate event
fvoucher_tarjetaview.Form_CustomValidate = 
...
fvoucher_tarjetaview.ValidateRequired = true;
<?php } else { ?>
fvoucher_tarjetaview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvoucher_tarjetaview.Lists["x_idbanco"] = {"LinkField":"x_idbanco","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fvoucher_tarjetaview.Lists["x_idcuenta"] = {"LinkField":"x_idcuenta","Ajax":true,"AutoFill":false,"DisplayFields":["x_numero","x_nombre","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } ?>
<?php $voucher_tarjeta_view->ExportOptions->Render("body") ?>
<?php
	foreach ($voucher_tarjeta_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($voucher_tarjeta->Export == "") { ?>
...
<?php } ?>
<?php $voucher_tarjeta_view->ShowPageHeader(); ?>
<?php
$voucher_tarjeta_view->ShowMessage();
?>
<form name="fvoucher_tarjetaview" id="fvoucher_tarjetaview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($voucher_tarjeta_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $voucher_tarjeta_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="voucher_tarjeta">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($voucher_tarjeta->idvoucher_tarjeta->Visible) { // idvoucher_tarjeta ?>
	<tr id="r_idvoucher_tarjeta">
		<td><span id="elh_voucher_tarjeta_idvoucher_tarjeta"><?php echo $voucher_tarjeta->idvoucher_tarjeta->FldCaption() ?></span></td>
		<td<?php echo $voucher_tarjeta->idvoucher_tarjeta->CellAttributes() ?>>
<span id="el_voucher_tarjeta_idvoucher_tarjeta" class="form-group">
<span<?php echo $voucher_tarjeta->idvoucher_tarjeta->ViewAttributes() ?>>
<?php echo $voucher_tarjeta->idvoucher_tarjeta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->idbanco->Visible) { // idbanco ?>
	<tr id="r_idbanco">
		<td><span id="elh_voucher_tarjeta_idbanco"><?php echo $voucher_tarjeta->idbanco->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->idbanco->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->idcuenta->Visible) { // idcuenta ?>
	<tr id="r_idcuenta">
		<td><span id="elh_voucher_tarjeta_idcuenta"><?php echo $voucher_tarjeta->idcuenta->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->idcuenta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->marca->Visible) { // marca ?>
	<tr id="r_marca">
		<td><span id="elh_voucher_tarjeta_marca"><?php echo $voucher_tarjeta->marca->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->marca->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_voucher_tarjeta_nombre"><?php echo $voucher_tarjeta->nombre->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->ultimos_cuatro_digitos->Visible) { // ultimos_cuatro_digitos ?>
	<tr id="r_ultimos_cuatro_digitos">
		<td><span id="elh_voucher_tarjeta_ultimos_cuatro_digitos"><?php echo $voucher_tarjeta->ultimos_cuatro_digitos->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->ultimos_cuatro_digitos->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->referencia->Visible) { // referencia ?>
	<tr id="r_referencia">
		<td><span id="elh_voucher_tarjeta_referencia"><?php echo $voucher_tarjeta->referencia->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->referencia->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_voucher_tarjeta_fecha"><?php echo $voucher_tarjeta->fecha->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->monto->Visible) { // monto ?>
	<tr id="r_monto">
		<td><span id="elh_voucher_tarjeta_monto"><?php echo $voucher_tarjeta->monto->FldCaption() ?></span></td>
...
<?php echo $voucher_tarjeta->monto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_voucher_tarjeta_descripcion"><?php echo $voucher_tarjeta->descripcion->FldCaption() ?></span></td>
		<td<?php echo $voucher_tarjeta->descripcion->CellAttributes() ?>>
<span id="el_voucher_tarjeta_descripcion" class="form-group">
<span<?php echo $voucher_tarjeta->descripcion->ViewAttributes() ?>>
<?php echo $voucher_tarjeta->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_voucher_tarjeta_estado"><?php echo $voucher_tarjeta->estado->FldCaption() ?></span></td>
		<td<?php echo $voucher_tarjeta->estado->CellAttributes() ?>>
<span id="el_voucher_tarjeta_estado" class="form-group">
<span<?php echo $voucher_tarjeta->estado->ViewAttributes() ?>>
<?php echo $voucher_tarjeta->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($voucher_tarjeta->fecha_insercion->Visible) { // fecha_insercion ?>
	<tr id="r_fecha_insercion">
		<td><span id="elh_voucher_tarjeta_fecha_insercion"><?php echo $voucher_tarjeta->fecha_insercion->FldCaption() ?></span></td>
		<td<?php echo $voucher_tarjeta->fecha_insercion->CellAttributes() ?>>
<span id="el_voucher_tarjeta_fecha_insercion" class="form-group">
<span<?php echo $voucher_tarjeta->fecha_insercion->ViewAttributes() ?>>
<?php echo $voucher_tarjeta->fecha_insercion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("pago_cliente", explode(",", $voucher_tarjeta->getCurrentDetailTable())) && $pago_cliente->DetailView) {
?>
...
<script type="text/javascript">
fvoucher_tarjetaview.Init();
</script>
<?php
$voucher_tarjeta_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($voucher_tarjeta->Export == "") { ?>
...
<?php
$voucher_tarjeta_view->Page_Terminate();
?>
