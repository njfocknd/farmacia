...
$medicamento_view = NULL; // Initialize page object first

class cmedicamento_view extends cmedicamento {
	...
	// Page object name
	var $PageObjName = 'medicamento_view';
	...
	function __construct() {
		...
		if (@$_GET["idmedicamento"] <> "") {
			$this->RecKey["idmedicamento"] = $_GET["idmedicamento"];
			$KeyUrl .= "&amp;idmedicamento=" . urlencode($this->RecKey["idmedicamento"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idmedicamento"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idmedicamento"]);
		}
		...
		$this->idmedicamento->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idmedicamento"] <> "") {
				...
				$this->RecKey["idmedicamento"] = $this->idmedicamento->QueryStringValue;
			} else {
				$sReturnUrl = "medicamentolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "medicamentolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "medicamentolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		if ($GLOBALS["registro_sanitario_grid"] && $GLOBALS["registro_sanitario_grid"]->DetailAdd) {
...
// Create page object
if (!isset($medicamento_view)) $medicamento_view = new cmedicamento_view();

// Page init
$medicamento_view->Page_Init();

// Page main
$medicamento_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$medicamento_view->Page_Render();
?>
...
// Page object
var medicamento_view = new ew_Page("medicamento_view");
medicamento_view.PageID = "view"; // Page ID
var EW_PAGE_ID = medicamento_view.PageID; // For backward compatibility

// Form object
var fmedicamentoview = new ew_Form("fmedicamentoview");

// Form_CustomValidate event
fmedicamentoview.Form_CustomValidate = 
...
fmedicamentoview.ValidateRequired = true;
<?php } else { ?>
fmedicamentoview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmedicamentoview.Lists["x_idpais"] = {"LinkField":"x_idpais","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fmedicamentoview.Lists["x_idmarca"] = {"LinkField":"x_idmarca","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } ?>
<?php $medicamento_view->ExportOptions->Render("body") ?>
<?php
	foreach ($medicamento_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($medicamento->Export == "") { ?>
...
<?php } ?>
<?php $medicamento_view->ShowPageHeader(); ?>
<?php
$medicamento_view->ShowMessage();
?>
<form name="fmedicamentoview" id="fmedicamentoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($medicamento_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $medicamento_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="medicamento">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($medicamento->idmedicamento->Visible) { // idmedicamento ?>
	<tr id="r_idmedicamento">
		<td><span id="elh_medicamento_idmedicamento"><?php echo $medicamento->idmedicamento->FldCaption() ?></span></td>
		<td<?php echo $medicamento->idmedicamento->CellAttributes() ?>>
<span id="el_medicamento_idmedicamento" class="form-group">
<span<?php echo $medicamento->idmedicamento->ViewAttributes() ?>>
<?php echo $medicamento->idmedicamento->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($medicamento->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_medicamento_nombre"><?php echo $medicamento->nombre->FldCaption() ?></span></td>
...
<?php echo $medicamento->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($medicamento->idpais->Visible) { // idpais ?>
	<tr id="r_idpais">
		<td><span id="elh_medicamento_idpais"><?php echo $medicamento->idpais->FldCaption() ?></span></td>
...
<?php echo $medicamento->idpais->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($medicamento->idmarca->Visible) { // idmarca ?>
	<tr id="r_idmarca">
		<td><span id="elh_medicamento_idmarca"><?php echo $medicamento->idmarca->FldCaption() ?></span></td>
...
<?php echo $medicamento->idmarca->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($medicamento->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_medicamento_estado"><?php echo $medicamento->estado->FldCaption() ?></span></td>
...
<?php echo $medicamento->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("registro_sanitario", explode(",", $medicamento->getCurrentDetailTable())) && $registro_sanitario->DetailView) {
?>
...
<script type="text/javascript">
fmedicamentoview.Init();
</script>
<?php
$medicamento_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($medicamento->Export == "") { ?>
...
<?php
$medicamento_view->Page_Terminate();
?>
