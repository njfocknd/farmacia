...
<?php if ($empresa->idempresa->Visible) { // idempresa ?>
		<th><span id="elh_empresa_idempresa" class="empresa_idempresa"><?php echo $empresa->idempresa->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($empresa->direccion->Visible) { // direccion ?>
		<th><span id="elh_empresa_direccion" class="empresa_direccion"><?php echo $empresa->direccion->FldCaption() ?></span></th>
<?php } ?>
<?php if ($empresa->estado->Visible) { // estado ?>
		<th><span id="elh_empresa_estado" class="empresa_estado"><?php echo $empresa->estado->FldCaption() ?></span></th>
<?php } ?>
<?php if ($empresa->idpais->Visible) { // idpais ?>
		<th><span id="elh_empresa_idpais" class="empresa_idpais"><?php echo $empresa->idpais->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $empresa_delete->RowCnt ?>_empresa_idempresa" class="form-group empresa_idempresa">
...
<span id="el<?php echo $empresa_delete->RowCnt ?>_empresa_nombre" class="form-group empresa_nombre">
...
<span id="el<?php echo $empresa_delete->RowCnt ?>_empresa_direccion" class="form-group empresa_direccion">
...
<span id="el<?php echo $empresa_delete->RowCnt ?>_empresa_estado" class="form-group empresa_estado">
...
<span id="el<?php echo $empresa_delete->RowCnt ?>_empresa_idpais" class="form-group empresa_idpais">
