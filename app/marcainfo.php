...
class cmarca extends cTable {
	...
	function __construct() {
		...
		// idfabricante
		$this->idfabricante = new cField('marca', 'marca', 'x_idfabricante', 'idfabricante', '`idfabricante`', '`idfabricante`', 3, -1, FALSE, '`idfabricante`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// fecha_insercion
		$this->fecha_insercion = new cField('marca', 'marca', 'x_fecha_insercion', 'fecha_insercion', '`fecha_insercion`', 'DATE_FORMAT(`fecha_insercion`, \'%d/%m/%Y\')', 135, 7, FALSE, '`fecha_insercion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
