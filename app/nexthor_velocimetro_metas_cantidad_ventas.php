...
function show_table()
	...
	strparams = { 'anio': anio, 'mes': mes,  'idsucursal': idsucursal,'nexthor_velocimetro_metas_cantidad_ventas': 1 };
	$.post( "nexthor_velocimetro_metas_cantidad_ventas_tabla.php", strparams, function(html){$(div).html(html);});
	}
</SCRIPT>
<?php
...
{?>
	<ul class="nav nav-pills">
	  ...
	  <li class="active"><a  href="nexthor_velocimetro_metas_cantidad_ventas.php">Velocímetro Meta y Cantidad de Ventas</a></li>
