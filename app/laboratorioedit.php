...
<?php if ($laboratorio->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_laboratorio_nombre" for="x_nombre" class="col-sm-2 control-label ewLabel"><?php echo $laboratorio->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $laboratorio->nombre->CellAttributes() ?>>
<span id="el_laboratorio_nombre">
<input type="text" data-field="x_nombre" name="x_nombre" id="x_nombre" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($laboratorio->nombre->PlaceHolder) ?>" value="<?php echo $laboratorio->nombre->EditValue ?>"<?php echo $laboratorio->nombre->EditAttributes() ?>>
</span>
<?php echo $laboratorio->nombre->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php if ($laboratorio->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group">
		<label id="elh_laboratorio_estado" for="x_estado" class="col-sm-2 control-label ewLabel"><?php echo $laboratorio->estado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $laboratorio->estado->CellAttributes() ?>>
<span id="el_laboratorio_estado">
<select data-field="x_estado" id="x_estado" name="x_estado"<?php echo $laboratorio->estado->EditAttributes() ?>>
<?php
...
<?php
	if (in_array("marca", explode(",", $laboratorio->getCurrentDetailTable())) && $marca->DetailEdit) {
?>
