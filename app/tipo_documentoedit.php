	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $tipo_documento->nombre->FldCaption(), $tipo_documento->nombre->ReqErrMsg)) ?>");
...
<?php if ($tipo_documento->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		<label id="elh_tipo_documento_nombre" for="x_nombre" class="col-sm-2 control-label ewLabel"><?php echo $tipo_documento->nombre->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($tipo_documento->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group">
		<label id="elh_tipo_documento_estado" for="x_estado" class="col-sm-2 control-label ewLabel"><?php echo $tipo_documento->estado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $tipo_documento->estado->CellAttributes() ?>>
<span id="el_tipo_documento_estado">
<select data-field="x_estado" id="x_estado" name="x_estado"<?php echo $tipo_documento->estado->EditAttributes() ?>>
<?php
if (is_array($tipo_documento->estado->EditValue)) {
	$arwrk = $tipo_documento->estado->EditValue;
	$rowswrk = count($arwrk);
	$emptywrk = TRUE;
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($tipo_documento->estado->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " selected=\"selected\"" : "";
...
<?php
	if (in_array("documento_debito", explode(",", $tipo_documento->getCurrentDetailTable())) && $documento_debito->DetailEdit) {
?>
