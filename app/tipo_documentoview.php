...
class ctipo_documento_view extends ctipo_documento {
	...
	function Page_Init() {
		...
		if (!$Security->CanView()) {
			...
			$this->Page_Terminate(ew_GetUrl("tipo_documentolist.php"));
		}
		...
		if (@$_GET["idtipo_documento"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idtipo_documento"]);
		}
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_tipo_documento\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tipo_documento',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.ftipo_documentoview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("documento_debito", $DetailTblVar)) {
				...
				if ($GLOBALS["documento_debito_grid"]->DetailView) {
					...
					$GLOBALS["documento_debito_grid"]->idtipo_documento->FldIsDetailKey = TRUE;
					$GLOBALS["documento_debito_grid"]->idtipo_documento->CurrentValue = $this->idtipo_documento->CurrentValue;
					$GLOBALS["documento_debito_grid"]->idtipo_documento->setSessionValue($GLOBALS["documento_debito_grid"]->idtipo_documento->CurrentValue);
				}
			}
		}
	}
...
<?php
	if (in_array("documento_debito", explode(",", $tipo_documento->getCurrentDetailTable())) && $documento_debito->DetailView) {
?>
