...
?>
<form name="fproductodelete" id="fproductodelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($producto_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $producto_delete->Token ?>">
<?php } ?>
...
<?php if ($producto->idproducto->Visible) { // idproducto ?>
		<th><span id="elh_producto_idproducto" class="producto_idproducto"><?php echo $producto->idproducto->FldCaption() ?></span></th>
<?php } ?>
<?php if ($producto->nombre->Visible) { // nombre ?>
		<th><span id="elh_producto_nombre" class="producto_nombre"><?php echo $producto->nombre->FldCaption() ?></span></th>
<?php } ?>
<?php if ($producto->idpais->Visible) { // idpais ?>
		<th><span id="elh_producto_idpais" class="producto_idpais"><?php echo $producto->idpais->FldCaption() ?></span></th>
<?php } ?>
<?php if ($producto->idmarca->Visible) { // idmarca ?>
		<th><span id="elh_producto_idmarca" class="producto_idmarca"><?php echo $producto->idmarca->FldCaption() ?></span></th>
<?php } ?>
<?php if ($producto->estado->Visible) { // estado ?>
		<th><span id="elh_producto_estado" class="producto_estado"><?php echo $producto->estado->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $producto_delete->RowCnt ?>_producto_idproducto" class="form-group producto_idproducto">
...
<span id="el<?php echo $producto_delete->RowCnt ?>_producto_nombre" class="form-group producto_nombre">
...
<span id="el<?php echo $producto_delete->RowCnt ?>_producto_idpais" class="form-group producto_idpais">
...
<span id="el<?php echo $producto_delete->RowCnt ?>_producto_idmarca" class="form-group producto_idmarca">
...
<span id="el<?php echo $producto_delete->RowCnt ?>_producto_estado" class="form-group producto_estado">
