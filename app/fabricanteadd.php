...
$fabricante_add = NULL; // Initialize page object first

class cfabricante_add extends cfabricante {
	...
	// Page object name
	var $PageObjName = 'fabricante_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["idfabricante"] != "") {
				...
				$this->setKey("idfabricante", $this->idfabricante->CurrentValue); // Set up key
			} else {
				$this->setKey("idfabricante", ""); // Clear key
...
// Create page object
if (!isset($fabricante_add)) $fabricante_add = new cfabricante_add();

// Page init
$fabricante_add->Page_Init();

// Page main
$fabricante_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fabricante_add->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var fabricante_add = new ew_Page("fabricante_add");
fabricante_add.PageID = "add"; // Page ID
var EW_PAGE_ID = fabricante_add.PageID; // For backward compatibility

// Form object
var ffabricanteadd = new ew_Form("ffabricanteadd");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $fabricante->nombre->FldCaption(), $fabricante->nombre->ReqErrMsg)) ?>");
...
ffabricanteadd.Form_CustomValidate = 
...
ffabricanteadd.ValidateRequired = true;
<?php } else { ?>
ffabricanteadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ffabricanteadd.Lists["x_idpais"] = {"LinkField":"x_idpais","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $fabricante_add->ShowPageHeader(); ?>
<?php
$fabricante_add->ShowMessage();
?>
<form name="ffabricanteadd" id="ffabricanteadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($fabricante_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $fabricante_add->Token ?>">
<?php } ?>
...
<?php if ($fabricante->nombre->Visible) { // nombre ?>
	<div id="r_nombre" class="form-group">
		...
		<div class="col-sm-10"><div<?php echo $fabricante->nombre->CellAttributes() ?>>
<span id="el_fabricante_nombre">
<input type="text" data-field="x_nombre" name="x_nombre" id="x_nombre" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($fabricante->nombre->PlaceHolder) ?>" value="<?php echo $fabricante->nombre->EditValue ?>"<?php echo $fabricante->nombre->EditAttributes() ?>>
</span>
<?php echo $fabricante->nombre->CustomMsg ?></div></div>
	</div>
<?php } ?>
