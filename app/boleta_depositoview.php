...
$boleta_deposito_view = NULL; // Initialize page object first

class cboleta_deposito_view extends cboleta_deposito {
	...
	// Page object name
	var $PageObjName = 'boleta_deposito_view';
	...
	function __construct() {
		...
		if (@$_GET["idboleta_deposito"] <> "") {
			$this->RecKey["idboleta_deposito"] = $_GET["idboleta_deposito"];
			$KeyUrl .= "&amp;idboleta_deposito=" . urlencode($this->RecKey["idboleta_deposito"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idboleta_deposito"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idboleta_deposito"]);
		}
		...
		$this->idboleta_deposito->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idboleta_deposito"] <> "") {
				...
				$this->RecKey["idboleta_deposito"] = $this->idboleta_deposito->QueryStringValue;
			} else {
				$sReturnUrl = "boleta_depositolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "boleta_depositolist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "boleta_depositolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($boleta_deposito_view)) $boleta_deposito_view = new cboleta_deposito_view();

// Page init
$boleta_deposito_view->Page_Init();

// Page main
$boleta_deposito_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$boleta_deposito_view->Page_Render();
?>
...
// Page object
var boleta_deposito_view = new ew_Page("boleta_deposito_view");
boleta_deposito_view.PageID = "view"; // Page ID
var EW_PAGE_ID = boleta_deposito_view.PageID; // For backward compatibility

// Form object
var fboleta_depositoview = new ew_Form("fboleta_depositoview");

// Form_CustomValidate event
fboleta_depositoview.Form_CustomValidate = 
...
fboleta_depositoview.ValidateRequired = true;
<?php } else { ?>
fboleta_depositoview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fboleta_depositoview.Lists["x_idbanco"] = {"LinkField":"x_idbanco","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fboleta_depositoview.Lists["x_idcuenta"] = {"LinkField":"x_idcuenta","Ajax":true,"AutoFill":false,"DisplayFields":["x_numero","x_nombre","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php } ?>
<?php $boleta_deposito_view->ExportOptions->Render("body") ?>
<?php
	foreach ($boleta_deposito_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($boleta_deposito->Export == "") { ?>
...
<?php } ?>
<?php $boleta_deposito_view->ShowPageHeader(); ?>
<?php
$boleta_deposito_view->ShowMessage();
?>
<form name="fboleta_depositoview" id="fboleta_depositoview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($boleta_deposito_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $boleta_deposito_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="boleta_deposito">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($boleta_deposito->idboleta_deposito->Visible) { // idboleta_deposito ?>
	<tr id="r_idboleta_deposito">
		<td><span id="elh_boleta_deposito_idboleta_deposito"><?php echo $boleta_deposito->idboleta_deposito->FldCaption() ?></span></td>
		<td<?php echo $boleta_deposito->idboleta_deposito->CellAttributes() ?>>
<span id="el_boleta_deposito_idboleta_deposito" class="form-group">
<span<?php echo $boleta_deposito->idboleta_deposito->ViewAttributes() ?>>
<?php echo $boleta_deposito->idboleta_deposito->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->idbanco->Visible) { // idbanco ?>
	<tr id="r_idbanco">
		<td><span id="elh_boleta_deposito_idbanco"><?php echo $boleta_deposito->idbanco->FldCaption() ?></span></td>
...
<?php echo $boleta_deposito->idbanco->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->idcuenta->Visible) { // idcuenta ?>
	<tr id="r_idcuenta">
		<td><span id="elh_boleta_deposito_idcuenta"><?php echo $boleta_deposito->idcuenta->FldCaption() ?></span></td>
...
<?php echo $boleta_deposito->idcuenta->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->numero->Visible) { // numero ?>
	<tr id="r_numero">
		<td><span id="elh_boleta_deposito_numero"><?php echo $boleta_deposito->numero->FldCaption() ?></span></td>
...
<?php echo $boleta_deposito->numero->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->fecha->Visible) { // fecha ?>
	<tr id="r_fecha">
		<td><span id="elh_boleta_deposito_fecha"><?php echo $boleta_deposito->fecha->FldCaption() ?></span></td>
...
<?php echo $boleta_deposito->fecha->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->efectivo->Visible) { // efectivo ?>
	<tr id="r_efectivo">
		<td><span id="elh_boleta_deposito_efectivo"><?php echo $boleta_deposito->efectivo->FldCaption() ?></span></td>
		<td<?php echo $boleta_deposito->efectivo->CellAttributes() ?>>
<span id="el_boleta_deposito_efectivo" class="form-group">
<span<?php echo $boleta_deposito->efectivo->ViewAttributes() ?>>
<?php echo $boleta_deposito->efectivo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->cheque->Visible) { // cheque ?>
	<tr id="r_cheque">
		<td><span id="elh_boleta_deposito_cheque"><?php echo $boleta_deposito->cheque->FldCaption() ?></span></td>
		<td<?php echo $boleta_deposito->cheque->CellAttributes() ?>>
<span id="el_boleta_deposito_cheque" class="form-group">
<span<?php echo $boleta_deposito->cheque->ViewAttributes() ?>>
<?php echo $boleta_deposito->cheque->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->cheque_otro->Visible) { // cheque_otro ?>
	<tr id="r_cheque_otro">
		<td><span id="elh_boleta_deposito_cheque_otro"><?php echo $boleta_deposito->cheque_otro->FldCaption() ?></span></td>
		<td<?php echo $boleta_deposito->cheque_otro->CellAttributes() ?>>
<span id="el_boleta_deposito_cheque_otro" class="form-group">
<span<?php echo $boleta_deposito->cheque_otro->ViewAttributes() ?>>
<?php echo $boleta_deposito->cheque_otro->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->monto->Visible) { // monto ?>
	<tr id="r_monto">
		<td><span id="elh_boleta_deposito_monto"><?php echo $boleta_deposito->monto->FldCaption() ?></span></td>
...
<?php echo $boleta_deposito->monto->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->descripcion->Visible) { // descripcion ?>
	<tr id="r_descripcion">
		<td><span id="elh_boleta_deposito_descripcion"><?php echo $boleta_deposito->descripcion->FldCaption() ?></span></td>
		<td<?php echo $boleta_deposito->descripcion->CellAttributes() ?>>
<span id="el_boleta_deposito_descripcion" class="form-group">
<span<?php echo $boleta_deposito->descripcion->ViewAttributes() ?>>
<?php echo $boleta_deposito->descripcion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_boleta_deposito_estado"><?php echo $boleta_deposito->estado->FldCaption() ?></span></td>
		<td<?php echo $boleta_deposito->estado->CellAttributes() ?>>
<span id="el_boleta_deposito_estado" class="form-group">
<span<?php echo $boleta_deposito->estado->ViewAttributes() ?>>
<?php echo $boleta_deposito->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($boleta_deposito->fecha_insercion->Visible) { // fecha_insercion ?>
	<tr id="r_fecha_insercion">
		<td><span id="elh_boleta_deposito_fecha_insercion"><?php echo $boleta_deposito->fecha_insercion->FldCaption() ?></span></td>
		<td<?php echo $boleta_deposito->fecha_insercion->CellAttributes() ?>>
<span id="el_boleta_deposito_fecha_insercion" class="form-group">
<span<?php echo $boleta_deposito->fecha_insercion->ViewAttributes() ?>>
<?php echo $boleta_deposito->fecha_insercion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("pago_cliente", explode(",", $boleta_deposito->getCurrentDetailTable())) && $pago_cliente->DetailView) {
?>
...
<script type="text/javascript">
fboleta_depositoview.Init();
</script>
<?php
$boleta_deposito_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($boleta_deposito->Export == "") { ?>
...
<?php
$boleta_deposito_view->Page_Terminate();
?>
