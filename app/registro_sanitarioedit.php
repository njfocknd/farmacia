...
<?php if ($registro_sanitario->idregistro_sanitario->Visible) { // idregistro_sanitario ?>
	<div id="r_idregistro_sanitario" class="form-group">
		<label id="elh_registro_sanitario_idregistro_sanitario" class="col-sm-2 control-label ewLabel"><?php echo $registro_sanitario->idregistro_sanitario->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $registro_sanitario->idregistro_sanitario->CellAttributes() ?>>
<span id="el_registro_sanitario_idregistro_sanitario">
<span<?php echo $registro_sanitario->idregistro_sanitario->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $registro_sanitario->idregistro_sanitario->EditValue ?></p></span>
</span>
...
<?php echo $registro_sanitario->idregistro_sanitario->CustomMsg ?></div></div>
	</div>
<?php } ?>
