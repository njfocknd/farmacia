...
$registro_sanitario_edit = NULL; // Initialize page object first

class cregistro_sanitario_edit extends cregistro_sanitario {
	...
	// Page object name
	var $PageObjName = 'registro_sanitario_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->idregistro_sanitario->CurrentValue == "")
			$this->Page_Terminate("registro_sanitariolist.php"); // Invalid key, return to list
	...
	function LoadFormValues() {
		...
		if (!$this->idregistro_sanitario->FldIsDetailKey)
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// idmedicamento
			$this->idmedicamento->SetDbValueDef($rsnew, $this->idmedicamento->CurrentValue, 0, $this->idmedicamento->ReadOnly);
...
// Create page object
if (!isset($registro_sanitario_edit)) $registro_sanitario_edit = new cregistro_sanitario_edit();

// Page init
$registro_sanitario_edit->Page_Init();

// Page main
$registro_sanitario_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$registro_sanitario_edit->Page_Render();
?>
<?php include_once $EW_RELATIVE_PATH . "header.php" ?>
<script type="text/javascript">

// Page object
var registro_sanitario_edit = new ew_Page("registro_sanitario_edit");
registro_sanitario_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = registro_sanitario_edit.PageID; // For backward compatibility

// Form object
var fregistro_sanitarioedit = new ew_Form("fregistro_sanitarioedit");

// Validate form
fregistro_sanitarioedit.Validate = function() {
...
fregistro_sanitarioedit.Form_CustomValidate = 
...
fregistro_sanitarioedit.ValidateRequired = true;
<?php } else { ?>
fregistro_sanitarioedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fregistro_sanitarioedit.Lists["x_idmedicamento"] = {"LinkField":"x_idmedicamento","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fregistro_sanitarioedit.Lists["x_idpais"] = {"LinkField":"x_idpais","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $registro_sanitario_edit->ShowPageHeader(); ?>
<?php
$registro_sanitario_edit->ShowMessage();
?>
<form name="fregistro_sanitarioedit" id="fregistro_sanitarioedit" class="form-horizontal ewForm ewEditForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($registro_sanitario_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $registro_sanitario_edit->Token ?>">
<?php } ?>
...
<?php if ($registro_sanitario->estado->Visible) { // estado ?>
	<div id="r_estado" class="form-group">
		<label id="elh_registro_sanitario_estado" for="x_estado" class="col-sm-2 control-label ewLabel"><?php echo $registro_sanitario->estado->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $registro_sanitario->estado->CellAttributes() ?>>
<span id="el_registro_sanitario_estado">
<select data-field="x_estado" id="x_estado" name="x_estado"<?php echo $registro_sanitario->estado->EditAttributes() ?>>
<?php
...
<input type="hidden" data-field="x_idregistro_sanitario" name="x_idregistro_sanitario" id="x_idregistro_sanitario" value="<?php echo ew_HtmlEncode($registro_sanitario->idregistro_sanitario->CurrentValue) ?>">
...
<script type="text/javascript">
fregistro_sanitarioedit.Init();
</script>
<?php
$registro_sanitario_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$registro_sanitario_edit->Page_Terminate();
?>
