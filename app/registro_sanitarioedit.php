...
class cregistro_sanitario_edit extends cregistro_sanitario {
	...
	function WriteAuditTrailOnEdit(&$rsold, &$rsnew) {
		...
		$key .= $rsold['idregistro_sanitario'];
...
fregistro_sanitarioedit.Lists["x_idproducto"] = {"LinkField":"x_idproducto","Ajax":true,"AutoFill":false,"DisplayFields":["x_nombre","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
