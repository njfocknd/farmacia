...
$producto_foto_blobview = NULL; // Initialize page object first

class cproducto_foto_blobview extends cproducto {
	...
	// Page object name
	var $PageObjName = 'producto_foto_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'producto');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('producto', 'x_foto');
...
// Create page object
if (!isset($producto_foto_blobview)) $producto_foto_blobview = new cproducto_foto_blobview();

// Page init
$producto_foto_blobview->Page_Init();

// Page main
$producto_foto_blobview->Page_Main();
?>
<?php
$producto_foto_blobview->Page_Terminate();
?>
