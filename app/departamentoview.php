...
class cdepartamento_view extends cdepartamento {
	...
	function SetupOtherOptions() {
		...
		$links = "";
		if ($GLOBALS["municipio_grid"] && $GLOBALS["municipio_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'municipio')) {
		...
		if ($GLOBALS["municipio_grid"] && $GLOBALS["municipio_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'municipio')) {
		...
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'municipio');
		if ($item->Visible) {
