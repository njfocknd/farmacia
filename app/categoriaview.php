...
class ccategoria_view extends ccategoria {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["idcategoria"] <> "") {
			$this->RecKey["idcategoria"] = $_GET["idcategoria"];
			$KeyUrl .= "&amp;idcategoria=" . urlencode($this->RecKey["idcategoria"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["idcategoria"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["idcategoria"]);
		}
		...
		$this->idcategoria->Visible = !$this->IsAdd() && !$this->IsCopy() && !$this->IsGridAdd();
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["idcategoria"] <> "") {
				$this->idcategoria->setQueryStringValue($_GET["idcategoria"]);
				$this->RecKey["idcategoria"] = $this->idcategoria->QueryStringValue;
			} else {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("producto", $DetailTblVar)) {
				...
				if ($GLOBALS["producto_grid"]->DetailView) {
					...
					$GLOBALS["producto_grid"]->idcategoria->FldIsDetailKey = TRUE;
					$GLOBALS["producto_grid"]->idcategoria->CurrentValue = $this->idcategoria->CurrentValue;
					$GLOBALS["producto_grid"]->idcategoria->setSessionValue($GLOBALS["producto_grid"]->idcategoria->CurrentValue);
				}
			}
		}
	}
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", $this->TableVar, "categorialist.php", "", $this->TableVar, TRUE);
		$PageId = "view";
...
// Form object
var fcategoriaview = new ew_Form("fcategoriaview");
...
fcategoriaview.ValidateRequired = true;
<?php } else { ?>
fcategoriaview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($categoria->idcategoria->Visible) { // idcategoria ?>
	<tr id="r_idcategoria">
		<td><span id="elh_categoria_idcategoria"><?php echo $categoria->idcategoria->FldCaption() ?></span></td>
		<td<?php echo $categoria->idcategoria->CellAttributes() ?>>
<span id="el_categoria_idcategoria" class="form-group">
<span<?php echo $categoria->idcategoria->ViewAttributes() ?>>
<?php echo $categoria->idcategoria->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($categoria->nombre->Visible) { // nombre ?>
	<tr id="r_nombre">
		<td><span id="elh_categoria_nombre"><?php echo $categoria->nombre->FldCaption() ?></span></td>
...
<?php echo $categoria->nombre->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($categoria->estado->Visible) { // estado ?>
	<tr id="r_estado">
		<td><span id="elh_categoria_estado"><?php echo $categoria->estado->FldCaption() ?></span></td>
		<td<?php echo $categoria->estado->CellAttributes() ?>>
<span id="el_categoria_estado" class="form-group">
<span<?php echo $categoria->estado->ViewAttributes() ?>>
<?php echo $categoria->estado->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($categoria->fecha_insercion->Visible) { // fecha_insercion ?>
	<tr id="r_fecha_insercion">
		<td><span id="elh_categoria_fecha_insercion"><?php echo $categoria->fecha_insercion->FldCaption() ?></span></td>
		<td<?php echo $categoria->fecha_insercion->CellAttributes() ?>>
<span id="el_categoria_fecha_insercion" class="form-group">
<span<?php echo $categoria->fecha_insercion->ViewAttributes() ?>>
<?php echo $categoria->fecha_insercion->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("producto", explode(",", $categoria->getCurrentDetailTable())) && $producto->DetailView) {
?>
<?php if ($categoria->getCurrentDetailTable() <> "") { ?>
