...
{?>
        ...
        <script>
            ...
            function fncIniciarGrafica(){
                ...
                chart.addTitle("Velocímetro de Meta y Cantidad de Ventas");
                ...
                axis.setBottomText(" Número de Meta "+ value );
				window.setTimeout(function(){
					value = <?php echo $arr_datos['monto_documento_debito'];?>;
					arrow.setValue(value);
					axis.setBottomText("  Número de Ventas "+ value );
					}, 2000);
            }
...
if (isset($_POST["nexthor_velocimetro_metas_cantidad_ventas"]))
	{
		$arr_datos = array();
		...
		$query="select m.idsucursal, m.idperiodo_contable, ifnull(m.cantidad,0) monto_meta
		...
		$query="select dd.idsucursal, fc.idperiodo_contable, count(ifnull(dd.monto,0)) monto_documento_debito
