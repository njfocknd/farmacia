...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_idmedicamento") && $objForm->HasValue("o_idmedicamento") && $this->idmedicamento->CurrentValue <> $this->idmedicamento->OldValue)
			return FALSE;
	...
	function LoadDefaultValues() {
		...
		$this->idmedicamento->OldValue = $this->idmedicamento->CurrentValue;
	...
	function LoadFormValues() {
		...
		$this->idmedicamento->setOldValue($objForm->GetValue("o_idmedicamento"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "medicamento") {
			...
			if ($GLOBALS["medicamento"]->EventCancelled) $this->EventCancelled = TRUE;
		}
